...
@Component
public class AsyncEventAppRunner implements ApplicationRunner {

	private static final Logger logger = LoggerFactory.getLogger(AsyncEventAppRunner.class);
	...
	@Autowired
	public AsyncEventAppRunner(ApplicationEventPublisher publisher) {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		logger.info("AsyncEventAppRunner finished execution");
	}
